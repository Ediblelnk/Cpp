...
/**
 * @brief Write the delta the file currently opened by ofs
 *
 * @param ofs IMPORT:EXPORT: out file stream object
 * @param start IMPORT: start time used to calculate delta
 * @param end IMPORT: end time used to calculate delta
 */
void writeDelta(ofstream &ofs, chrono::_V2::system_clock::time_point start, chrono::_V2::system_clock::time_point end);
